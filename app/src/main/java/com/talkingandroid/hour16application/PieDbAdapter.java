 ...
 */
    ...
    public class PieDbAdapter {
        ...
        private static final String CREATE_TABLE_PIE=" create table "+PIE_TABLE+" ( "+KEY_ROWID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+NAME+" not null UNIQUE ,"+DESCRIPTION+" text, "+PRICE+" REAL ,"+FAVORITE+" INTEGER "+" ); ";
        ...
        public long insertPie(ContentValues initialValues) {
            return mDb.insertWithOnConflict(
                    PIE_TABLE, null, initialValues, SQLiteDatabase.CONFLICT_IGNORE);
        }
